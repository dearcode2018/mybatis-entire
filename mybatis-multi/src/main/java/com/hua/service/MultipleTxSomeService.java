/**
  * @filename MultipleTxSomeService.java
  * @description 
  * @version 1.0
  * @author qianye.zheng
 */
...
/**
 * @type MultipleTxSomeService
 * @description 
 * @author qianye.zheng
 */
@Service
public class MultipleTxSomeService {
	 ...
	 * 
	 * @description 
	 * 1) 使用调用方的事务，当前方法声明的数据源无效，事务优先的原则，因为声明权在被调用的方法手中，属于愿意受调用方的影响
	 * 2) 调用方没有事务，调用此方法将获取新的数据连接，创建新的事务
	 * @param entity
	 * @return
	 * @author qianye.zheng
	 */
	...
	public int propagationRequiredDB2(final Person entity) {
	...
	@DataSource(name = DataSourceNames.DB2)
	public int propagationRequiresNewDB2(final Person entity) {
		personMapper.insert(entity);
