 ...
 * @author qye.zheng
 */
public interface CityMapper extends CoreMapper<Integer, City> {
	...
	*/
	 ...
	 * @author qye.zheng
	 */
	public abstract CityVo singleBasicNoNameParam(final int id);
	 ...
	 * @author qye.zheng
	 */
	public abstract CityVo singleBasicNameParam(@Param("id") final int id);
	 ...
	 * @author qye.zheng
	 */
	public abstract Collection<CityVo> multipleBasicNoNameParam(final int id, final String name, 
	 ...
	 * @author qye.zheng
	 */
	public abstract Collection<CityVo> multipleBasicNameParam(@Param("id") final int id, @Param("name") final String name, 
